...
namespace DriveIt.Settings
{
    ...
    public sealed class ModSettings : SettingsXMLBase
    {
        ...
        public const float             ENGINEPOWER = 350f;
        public const float             BRAKINGFORCE = 50f;
        public const float             DOWNFORCE = 10.0f;
        public const float             DRIVEBIAS = 0.5f;
        public const float             BRAKEBIAS = 0.5f;
        public const float             SPRINGDAMP = 2.25f;
        public const float             SPRINGOFFSET = -0.2f;
        public const float             SPRINGSWAYBAR = 77.0f;
        public const float             MASSCENTERHEIGHT = 0.1f;
        public const float             MASSCENTERBIAS = 0.55f;

        public const float             BIKEENGINEPOWER = 150f;
        public const float             BIKEBRAKINGFORCE = 8f;
        public const float             BIKEDOWNFORCE = 15.0f;
        public const float             BIKEDRIVEBIAS = 0.6f;
        public const float             BIKEBRAKEBIAS = 0.0f;
        public const float             BIKESPRINGDAMP = 4.0f;
        public const float             BIKESPRINGOFFSET = -0.05f;
        public const float             BIKEMASSCENTERHEIGHT = 0.05f;
        public const float             BIKEMASSCENTERBIAS = 0.5f;

        public const float             BOATENGINEPOWER = 25000f;
        public const float             BOATBRAKINGFORCE = 200f;
        ...
        public const float             CARENGINEPOWER = 350f;
        public const float             CARBRAKINGFORCE = 50f;
        public const float             CARDOWNFORCE = 15.0f;
        public const float             CARDRIVEBIAS = 0.65f;
        public const float             CARBRAKEBIAS = 0.65f;
        public const float             CARSPRINGDAMP = 3.3f;
        public const float             CARSPRINGOFFSET = -0.1f;
        public const float             CARSPRINGSWAYBAR = 97.0f;
        public const float             CARMASSCENTERHEIGHT = 0.05f;
        ...
        public const float             TRAINENGINEPOWER = 2000f;
        public const float             TRAINBRAKINGFORCE = 100f;
        ...
        public static readonly Vector3 OFFSET = new Vector3(0f, 2f, 0f);
        public const float             CAMMOUSEROTATESENSITIVITY = 1f;
        public const float             CAMKEYROTATESENSITIVITY = 1f;
        public const float             CAMFIELDOFVIEW = 80f;
        public const float             CAMMAXPITCH = 70f;
        public const float             CAMSMOOTHING = 1f;
        public static readonly Vector2 MAINBUTTONPOS = new Vector2(0f, 0f);
