...
namespace DriveIt.Settings.Tabs
{
    internal class ConfigHeli
    {
        public static void Populate(UIComponent panel)
        {
            ...
            var enginePower_Slider = SettingsPanel.CreateSlider(panel, SettingsPanel.MediumMargin, currentY, Translations.Translate(DriveCommon.TK_SETTINGS_ENGINEPOWER), 100.0f, 5000.0f, 50.0f, 1.0f, "N0", " kW");
