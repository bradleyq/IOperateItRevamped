...
namespace DriveIt.Utils
{
    internal static class DriveCommon
    {
        ...
        public const string TK_SETTINGS_TAB_BOAT            = "SETTINGS_TAB_BOAT";
        public const string TK_SETTINGS_TAB_CAR             = "SETTINGS_TAB_CAR";
        public const string TK_SETTINGS_TAB_HELI            = "SETTINGS_TAB_HELI";
        public const string TK_SETTINGS_TAB_PLANE           = "SETTINGS_TAB_PLANE";
        public const string TK_SETTINGS_TAB_TRAILER         = "SETTINGS_TAB_TRAILER";
        public const string TK_SETTINGS_TAB_TRAIN           = "SETTINGS_TAB_TRAIN";
        public const string TK_SETTINGS_TAB_KEYS            = "SETTINGS_TAB_KEYS";
        ...
        public const string TK_SETTINGS_GROUP_BIKE          = "SETTINGS_GROUP_BIKE";
        public const string TK_SETTINGS_GROUP_BOAT          = "SETTINGS_GROUP_BOAT";
        public const string TK_SETTINGS_GROUP_CAR           = "SETTINGS_GROUP_CAR";
        public const string TK_SETTINGS_GROUP_HELI          = "SETTINGS_GROUP_HELI";
        public const string TK_SETTINGS_GROUP_PLANE         = "SETTINGS_GROUP_PLANE";
        public const string TK_SETTINGS_GROUP_TRAILER       = "SETTINGS_GROUP_TRAILER";
        public const string TK_SETTINGS_GROUP_TRAIN         = "SETTINGS_GROUP_TRAIN";
        ...
        public const string TK_SETTINGS_DOWNFORCE           = "SETTINGS_DOWNFORCE";
        public const string TK_SETTINGS_DRIVEBIAS           = "SETTINGS_DRIVEBIAS";
        public const string TK_SETTINGS_BRAKEBIAS           = "SETTINGS_BRAKEBIAS";
        public const string TK_SETTINGS_GRIPCOEFFS          = "SETTINGS_GRIPCOEFFS";
        public const string TK_SETTINGS_GRIPCOEFFK          = "SETTINGS_GRIPCOEFFK";
        public const string TK_SETTINGS_SPRINGDAMP          = "SETTINGS_SPRINGDAMP";
        public const string TK_SETTINGS_SPRINGOFFSET        = "SETTINGS_SPRINGOFFSET";
        public const string TK_SETTINGS_SPRINGSWAYBAR       = "SETTINGS_SPRINGSWAYBAR";
        public const string TK_SETTINGS_MASSCENTERHEIGHT    = "SETTINGS_MASSCENTERHEIGHT";
        public const string TK_SETTINGS_MASSCENTERBIAS      = "SETTINGS_MASSCENTERBIAS";
        public const string TK_SETTINGS_CAM_MOUSE_SENSE     = "SETTINGS_CAM_MOUSE_SENSE";
        public const string TK_SETTINGS_CAM_KEY_SENSE       = "SETTINGS_CAM_KEY_SENSE";
        public const string TK_SETTINGS_CAM_FIELD_OF_VIEW   = "SETTINGS_CAM_FIELD_OF_VIEW";
        public const string TK_SETTINGS_CAM_MAX_PITCH_DEG   = "SETTINGS_CAM_MAX_PITCH_DEG";
        ...
        public const string TK_SETTINGS_KEYCAMCURSORTOGGLE  = "SETTINGS_KEYCAMCURSORTOGGLE";
        public const string TK_SETTINGS_KEYCAMZOOMIN        = "SETTINGS_KEYCAMZOOMIN";
        public const string TK_SETTINGS_KEYCAMZOOMOUT       = "SETTINGS_KEYCAMZOOMOUT";
        public const string TK_SETTINGS_KEYCAMRESET         = "SETTINGS_KEYCAMRESET";
        public const string TK_SETTINGS_KEYROTATECAMUP      = "SETTINGS_KEYROTATECAMUP";
        public const string TK_SETTINGS_KEYROTATECAMDOWN    = "SETTINGS_KEYROTATECAMDOWN";
        public const string TK_SETTINGS_KEYROTATECAMLEFT    = "SETTINGS_KEYROTATECAMLEFT";
        public const string TK_SETTINGS_KEYROTATECAMRIGHT   = "SETTINGS_KEYROTATECAMRIGHT";
